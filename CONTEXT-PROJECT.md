...
> Versión actual: **v4.28.0** (EDA renderer overhaul 2026-05-06)
> Tagline: _"Tu memoria técnica siempre disponible"_
> Estado: **Production-ready** (local + Railway)
>
> Nota: el changelog de abajo refleja v4.23.0, v4.27.0 y v4.28.0; las versiones intermedias (v4.24/4.25/4.26) están documentadas en la memoria del proyecto pero aún no migradas aquí.
