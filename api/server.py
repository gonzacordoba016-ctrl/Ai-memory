...
# ── Lazy DB init — corre en el primer request, no en startup ──────────
# El startup event en Railway puede correr ANTES de que el volumen esté
# montado. Diferir al primer request garantiza que el volumen ya existe.
